...
export function PhrasesNavigator() {
  return (
    <Stack.Navigator>
      <Stack.Screen name="PhrasesTopics" component={PhrasesTopicsScreen} options={{ title: 'Phrases' }} />
      <Stack.Screen name="PhraseTopic" component={PhraseTopicScreen} options={{ title: 'Topic' }} />
    </Stack.Navigator>
  );
}
